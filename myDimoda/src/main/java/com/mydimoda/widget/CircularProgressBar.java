...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		String t = a.getString(R.styleable.CircularProgressBar_title_);
		if(t!=null)
			mTitle = t;

		t = a.getString(R.styleable.CircularProgressBar_subtitle_);
		if(t!=null)
			mSubTitle = t;

		mStrokeWidth = a.getInt(R.styleable.CircularProgressBar_strokeWidth1, STROKE_WIDTH);
