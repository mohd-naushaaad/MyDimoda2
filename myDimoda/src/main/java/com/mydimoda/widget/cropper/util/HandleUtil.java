...
public class HandleUtil {
	...
	public static Handle getPressedHandle(float x, float y,
	...
	private static boolean isInHorizontalTargetZone(float x, float y,
            										float handleXStart, float handleXEnd,
	...
	private static boolean isInVerticalTargetZone(float x, float y,
            									  float handleX, float handleYStart,
	...
	private static boolean isInCenterTargetZone(float x, float y, 
												float left, float top, float right, float bottom) {
