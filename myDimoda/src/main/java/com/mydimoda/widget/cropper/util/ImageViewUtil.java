...
public class ImageViewUtil {
	...
	public static Rect getBitmapRectCenterCrop(Bitmap bitmap, View view) {
        ...
        return getBitmapRectCenterCropHelper(bitmapWidth, bitmapHeight, viewWidth, viewHeight);
    }
	...
	public static Rect getBitmapRectCenterCrop(int bitmapWidth,
								            	int bitmapHeight,
									            int viewWidth,
									            int viewHeight)
	{
	...
	private static Rect getBitmapRectCenterCropHelper(int bitmapWidth, int bitmapHeight,
													  int viewWidth, int viewHeight) {
		
		final Rect result = new Rect(0, 0,
				 0 + (int) Math.ceil(viewWidth),
				 0 + (int) Math.ceil(viewHeight));
	...
	/*	double resultWidth;
        ...
        final Rect result = new Rect(resultX, resultY,
